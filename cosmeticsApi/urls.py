...
from .views import product_list, product_detail, saveditem_list, saveditem_detail, saveditem_create, saveditem_delete, cart_items, wishlist_items, login, register, logout, product_create, saveditem_create, order_create, product_search
from . import views
